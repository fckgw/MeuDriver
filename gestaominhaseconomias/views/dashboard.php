...
$sql_f = "SELECT SUM(CASE WHEN tipo='Receita' THEN valor ELSE 0 END) as rec, 
                 SUM(CASE WHEN tipo='Despesa' THEN valor ELSE 0 END) as desp 
          FROM minhaseconomias_movimentacoes 
          WHERE usuario_id=? AND status IN ('Futuro','Atrasado') AND MONTH(data_vencimento)=? AND YEAR(data_vencimento)=? $where_conta";
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- Mudei para type="tel" para habilitar teclado numérico e aceitar a máscara JS -->
